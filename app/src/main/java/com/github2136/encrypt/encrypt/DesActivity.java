...
public class DESActivity extends AppCompatActivity {
    ...
    private RadioButton rbByte, rbBase64;
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.btn_key: {
                    ...
                    SecretKey key = (SecretKey) EncryptUtil.getKey(EncryptUtil.DES, 64);
                ...
                case R.id.btn_encrypt: {
                    ...
                    byte[] encryptData = EncryptUtil.getInstance(EncryptUtil.DES)
                            .setKey(key)
                ...
                case R.id.btn_decrypt: {
                    ...
                    byte[] decryptData = EncryptUtil.getInstance(EncryptUtil.DES)
                            .setKey(key)
