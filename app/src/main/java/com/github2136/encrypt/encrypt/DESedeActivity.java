...
public class DESedeActivity extends AppCompatActivity {
    ...
    private RadioButton rbByte, rbBase64, rbKey16, rbKey24;
    private ClipboardUtil mClipboardUtil;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_desede);
        setTitle("DESede");
            ...
            switch (v.getId()) {
                case R.id.btn_key: {
                    ...
                    if (rbKey16.isChecked()) {
                        key = (SecretKey) EncryptUtil.getKey(EncryptUtil.DESede, 128);
                    } else {
                        key = (SecretKey) EncryptUtil.getKey(EncryptUtil.DESede, 192);
                    }
                ...
                case R.id.btn_encrypt: {
                    ...
                    byte[] encryptData = EncryptUtil.getInstance(EncryptUtil.DESede)
                            .setKey(key)
                ...
                case R.id.btn_decrypt: {
                    ...
                    byte[] decryptData = EncryptUtil.getInstance(EncryptUtil.DESede)
                            .setKey(key)
